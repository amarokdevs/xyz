...
export default function Home() {
  ...
  const generateHTML = async () => {
    ...
    const generatedPageStyle = `
      ...
      .container { z-index: 1; position: relative; text-align: center; background: white; border-radius: 1.5rem; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); width: 100%; max-width: 42rem; padding: 2rem; }
